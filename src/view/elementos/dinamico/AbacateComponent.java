...
public class AbacateComponent extends ElementoComponent{
    ...
    public AbacateComponent(Abacate a){
        this.abacate = a;
        ImageIcon referencia = new ImageIcon(getClass().getResource("/res/images/abacate.png"));  //colocar a referência depois
    ...
    int offsetY = cellSize - frutaSize;
        g.drawImage(imagemAbacate, x + offsetX, y +offsetY, 16, 16, null);
    }
